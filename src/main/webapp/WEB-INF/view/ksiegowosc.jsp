...
<head>
    ...
    <style>
        <%@include file="/WEB-INF/fonts_ksiegowosc/fontawesome-all.min.css" %>
    </style>
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0">
            <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <h5 class="display-4" style="color:black"><a
                       <a href="${pageContext.request.contextPath}/ksiegowosc"><spring:message code="ks.allList"/></a>
                    | <a href="${pageContext.request.contextPath}/ksiegowosc"> <spring:message code="ks.mainPage"/></a>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                <div class="container-fluid">
                    ...
                    <form class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        ...
                        <div class="input-group">
                            ...
                            <form action="/SpringSec/ksiegowosc/szukaj" method="GET">
                                ...
                                <input name="Searchtext" class="bg-light form-control border-0 small" type="text"
                                       placeholder="Search for ...">

                                <input type="submit" value="<spring:message code="ks.search"/>"
                    ...
                    <a href="${pageContext.request.contextPath}/ksiegowosc/showforadd">
                        <button type="button" class="btn btn-secondary btn-lg "><spring:message
                                code="ks.addNewWorker"/></button>
                    </a>
                                ...
                                <c:forEach var="tempWorkers" items="${workers}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="${updateLink}">
                                                <button type="button" class="btn btn-warning" style="height:33px">
                                                    <spring:message code="ks.update"/></button>
                                                |</a>

                                            <a href="${deleteLink}"
                                               onclick="if (!(confirm('Jestes pewny, ze chcesz usunac pracownika?'))) return false">
                                                <button type="button" class="btn btn-danger" style="height:33px">
                                                    <spring:message code="ks.delete"/></button>
                                            </a>
                                        </td>
                        ...
                        <div class="row">
                            <div class="col-md-6 align-self-center">
                                <p id="dataTable_info" class="dataTables_info" role="status" aria-live="polite">Showing
                                    <c:out value="${liczba_pracownikow}"/> to 10 of <c:out
                                            value="${liczba_pracownikow}"/> (Total count)</p>
                            </div>
                            <div class="col-md-6">
                                <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                    <ul class="pagination">
                                        <li class="page-item disabled"><a class="page-link" href="#"
                                                ...
                                                aria-hidden="true">A</span></a></li>
                                        <li class="page-item active"><a class="page-link" href="#">1</a></li>
                                        <li class="page-item"><a class="page-link" href="#">2</a></li>
                                        <li class="page-item"><a class="page-link" href="#">3</a></li>
                                        <li class="page-item"><a class="page-link" href="#" aria-label="Next"><span
                                                aria-hidden="true">B</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
        ...
        <div class="jumbotron">
            <div class="dropdown">
                ...
                <a href="${pageContext.request.contextPath}/ksiegowosc/email" class="btn btn-secondary btn-lg active"
                   role="button" aria-pressed="true" style="margin-left:20px; margin-right:20px;">Wyslij liste
                    pracownikow na maila kierownika</a>
